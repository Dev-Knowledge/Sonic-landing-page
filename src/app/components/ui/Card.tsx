...
function Card({ name, className }: { name: string; className?: string }) {
  return (
    <div
    ...
    >
      ...
      >
        <Image src={name} alt="logo" width={220} height={220} />
      </div>
      <div className="hidden w-full md:flex flex-col items-start justify-center p-5 rounded-t-2xl bg-white border-2 border-[#2D2C2B]">
        <h2
          className={`${inter.className} flex-1 lg:text-xl text-sm font-extrabold`}
        >
          SONIC LAUNCH PARTY
        </h2>
